...
void asio_destroy(void *vptr)
{
	...
	bfree((void*)global_listener[index]->device_name);
	paasio_data *paasiodata = (paasio_data *)global_listener[index]->get_user_data();
